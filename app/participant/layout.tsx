...
const navItems = [
  ...
  { href: "/participant/events", label: "Events", icon: Calendar },
  { href: "/participant/registrations", label: "My Tickets", icon: Ticket },
  { href: "/participant/id-card", label: "ID Card", icon: CreditCard },
];
